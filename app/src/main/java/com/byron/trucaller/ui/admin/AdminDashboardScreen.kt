    ...
    Column(modifier = Modifier.fillMaxSize().background(Background)) {
        ...
        Column(
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                StatCard(Modifier.weight(1f), "Users", userCount, BrandDark)
            ...
            Card(
                ...
                Column {
                    AdminMenuItem(Icons.Default.PhoneAndroid, "Devices", "${devices.size} registered", BrandDark) {
                    ...
                    AdminMenuItem(Icons.Default.Phone, "Caller ID Database", "Manage spam database", BrandDark) {
