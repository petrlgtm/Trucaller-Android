        ...
        Box(
            ...
            Column {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("Contacts", color = Color.White, fontSize = 24.sp, fontWeight = FontWeight.Bold)
                    ...
                    Box(
                        ...
                        Text("${userContacts.size}", color = Color.White, fontWeight = FontWeight.Bold, fontSize = 14.sp)
                    }
                }
                if (lastSynced != null) {
                    Text(
            ...
            Card(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (isDriveConnected) Brand else Inactive,
                    ...
                    items(contacts, key = { it.id }) { contact ->
                        val avatarColor = remember(contact.name) {
                            val pastelColors = listOf(
                                ...
                                Color(0xFFFFF3E0), Color(0xFFEDE7F6), Color(0xFFE0F7FA),
                                Color(0xFFFFF8E1), Color(0xFFF3E5F5)
                            )
                            pastelColors[contact.name.hashCode().absoluteValue % pastelColors.size]
                        }
                        val textColor = remember(contact.name) {
                            val colors = listOf(
                                Color(0xFF1565C0), Color(0xFFC62828), Color(0xFF2E7D32),
                                Color(0xFFE65100), Color(0xFF4527A0), Color(0xFF00695C),
                                Color(0xFFF9A825), Color(0xFF6A1B9A)
                            )
                            colors[contact.name.hashCode().absoluteValue % colors.size]
                        }
